...
const carouselItems = [
  {
    ...
    subtitle: "Эрүүл мэндийн хүртээмжийг сайжруулъя",
  },
  {
    image: "/images/2.jpg",
    title: "Өвчтөнүүдийн үзлэгийг хялбаршуулъя,",
    subtitle: "хүссэн цагтаа, хаанаас ч",
  },
  {
    image: "/images/3.jpg",
    title: "Чадвараа нэмэгдүүлье,",
    subtitle: "Телемедициний тусламжтайгаар",
  },
];
